const char body_html[] PROGMEM = R"=====(    <form>
        ...
        <fieldset>
            ...
            <div style="white-space: nowrap;">
                <input type="checkbox" name="hdmode" id="hdmode" value="1" onchange="prepareParameterUpdate();return false;" />
                HD Mode
            </div>

            <div style="white-space: nowrap;">            
                <input type="checkbox" id="itison" value="0" onchange="prepareParameterUpdate();return false;" />
                "Es Ist" immer an
            </div>

            <div style="white-space: nowrap;">                        
                <input type="checkbox" id="speechmode" value="0" onchange="prepareParameterUpdate();return false;" />
                an = viertel zwei / aus = Viertel nach eins 
            </div>            
