const char body_html[] PROGMEM = R"=====(    <form>
        ...
        <fieldset>
            ...
            <input placeholder="password" id="password" type="password" oninput = "prepareParameterUpdate();return false;"/>            

            <label for="hdmode">HD Mode:</label>
            <input type="checkbox" id="hdmode" value="1" onchange="prepareParameterUpdate();return false;" />

            <label for="esistimmeran">"Es Ist" immer an</label>
            <input type="checkbox" id="esistimmeran" value="0" onchange="prepareParameterUpdate();return false;" />

            <label for="speechmode">an = viertel zwei / aus = Viertel nach eins </label>
            <input type="checkbox" id="speechmode" value="0" onchange="prepareParameterUpdate();return false;" />
